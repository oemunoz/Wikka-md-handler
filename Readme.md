...
```
 wikka.php?wakka=mmymdoc.md
```
![Directory estructure](images/mmymdoc_edit.png)
Renderised like (if you dont have highliht review the css and js prism path):
![Directory estructure](images/mmymdoc_parse.png)
